...
go_to_settings_stage_text = 'В настройках можно подписаться или отписаться от различных рассылок, а так же скоро именно здесь смогут настроить выбор группы студенты из ИМиСТа и магистранты'
