...
wrong_timetables = 'Принял! В ближайшее время я обязательно это проверю и, в случае обнаружения ошибки, исправлю. Если ты подписан на новости - то тебе придёт оповещение о том, что ошибка исправлена.'