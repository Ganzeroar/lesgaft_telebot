...
def return_location_of_class(chat_id, text):
    ...
    if len(name_of_location) <= 3:
        ...
        print('User: ' + str(chat_id) + ' ask about location ' + str(name_of_location))
...
def return_time_before_class_and_location(chat_id):
    ...
    if is_time_between(datetime.time(00,00), datetime.time(9,45)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 0, date)
    elif is_time_between(datetime.time(9,45), datetime.time(11,15)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 0, date, 'during')
    elif is_time_between(datetime.time(11,15), datetime.time(11,30)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 1, date)
    elif is_time_between(datetime.time(11,30), datetime.time(13,00)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 1, date, 'during')
    elif is_time_between(datetime.time(13,00), datetime.time(13,30)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 2, date)
    elif is_time_between(datetime.time(13,30), datetime.time(15,00)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 2, date, 'during')
    elif is_time_between(datetime.time(15,00), datetime.time(15,15)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 3, date)
    elif is_time_between(datetime.time(15,15), datetime.time(16,45)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 3, date, 'during')
    elif is_time_between(datetime.time(16,45), datetime.time(17,00)):
        text = return_text_about_time_before_lesson_with_location(chat_id, 4, date)
