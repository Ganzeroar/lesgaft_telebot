...
def find_class_location_used_number(number_of_class):
    locations = {
        ...
        '7': 'ИМиСТ, третий этаж ИЛИ Мойка, вход со стороны стадиона, второй этаж',
        '8': 'ИМиСТ, четвёртый этаж ИЛИ Мойка, вход со стороны стадиона, второй этаж',
        '9': 'Мойка, вход со стороны стадиона, второй этаж',
        '10': 'ИМиСТ, первый этаж',
        '11': 'ИМиСТ, первый этаж',
        '12': 'ИМиСТ, первый этаж',
        '13': 'ИМиСТ, первый этаж',
        ...
        '96': 'Мойка, первый этаж, после входа направо, налево и направо, по левую сторону',
        '97': 'Мойка, первый этаж, после входа направо, налево и направо, по левую сторону',
        '98': 'Мойка, первый этаж, после входа направо, налево и направо, по левую сторону',
        ...
        '150': 'При входе с Мойки, перед лестницей налево',
...
def find_department_location(name_of_department):
    ...
    locations = {
        ...
        'кафедра психологии': 'Главный корпус, второй этаж, выходишь с лестницы от библиотеки, налево, налево, по левую сторону',
        'кафедра социально-гуманитарных дисциплин': 'Главный корпус, второй этаж, от главной лестницы налево',
        ...
        'кафедра теории и методики спортивных игр': 'Главный корпус, второй этаж, от главной лестницы направо',
        'кафедра спортивных игр': 'Главный корпус, второй этаж, от главной лестницы направо',
        ...
        'кафедра физиологии': 'Главный корпус, 3 этаж, после лестницы направо, направо, до конца',
