...
existing_subjects = [
    ...
    'Обеспечение жизнедеятельности в сфере сервиса',
...
cell_values_to_skip_validator = [
    ...
    'УТЦ "Кавголово"\nВесенний фестиваль спорта, здоровья и ГТО, посвященного 77-ой годовщине Победы в Великой Отечественной войне',
]
