...
non_standart_group = [
    ...
    'плавание ii',
    'антидопинговое обеспечение в спорте, танц.спорт, спорт.акробат.., водные виды спорта, академ. гребля,гандбол,волейбол,легк. атл., плавание',
    'самбо, атлетизм',
